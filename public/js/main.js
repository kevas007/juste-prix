...
function main(){
    ...
    do {
       ...
       let niveau = window.prompt('Enter a value for niveau');
        ...
        do {
            ...
            proposition = window.prompt('Enter la value de la  proposition');
        ...
        alert("Voulez-vous rejouer ? true/false");
        envie = prompt('Enter a value for envie');
    } while (envie == "true");
